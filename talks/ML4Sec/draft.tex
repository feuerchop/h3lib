...
\usetheme{PaloAlto} % change theme
...
%% MAKE TITLE
\title{Machine Learning in Security}
\subtitle{An overview of machine learning research with focus on security problems}
\author{Huang Xiao \\ \small{\{xiao@sec.in.tum.de\}} }%\thanks{Funded by ARAMiS project}}
%\and Author2 \inst{1} }
%\and Author3 \inst{2}}
